...
<div class="panel panel-default">
    <div class="panel-heading clearfix">
        <span class="pull-left">
            <h4 class="mt-5 mb-5">Edit Production Order</h4>
        </span>
    ...
    <div class="panel-body">
        ...
        <form method="POST" action="{{ route('production_order.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="order_name" value="{{$production_order->order_name}}" type="text" id="order_name" minlength="1"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="company_name" value="{{$production_order->company_name}}" type="text" id="company_name" minlength="1"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="representative_name" value="{{$production_order->representative_name}}" type="text" id="representative_name"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="designation" value="{{$production_order->designation}}" type="text" id="designation" minlength="1"
                        maxlength="191" required="true" placeholder="Enter order here..." />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="email" value="{{$production_order->email}}" type="text" id="email" minlength="1" maxlength="191"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input class="form-control" name="phone" type="text" value="{{$production_order->phone}}" id="phone" minlength="1" maxlength="191"
        ...
        <div id="fileInputContainer-${productCount}" style="display:none;">
            <input type="file" name="background-${productCount}">
                    ...
                    <div class="form-group ">
                     ...
                     &nbsp;&nbsp;
                       <div class="d-flex"> YOU deliever at office    &nbsp;  <input type="radio" style="display:block !important"  name="sample-picking-${productCount}"  required="true">
                       </div>
                     &nbsp;&nbsp; <div class="d-flex">  We picked from your company  &nbsp;  <input type="radio" style="display:block !important"  name="sample-picking-${productCount}"  required="true">
                      </div>
                    </div>
