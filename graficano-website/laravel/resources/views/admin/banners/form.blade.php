<div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="title" type="text" id="title" value="{{ old('title', optional($banners)->title) }}" minlength="1" maxlength="191" required="true" placeholder="Enter title here...">
...
<div class="form-group {{ $errors->has('url') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="url" type="text" id="title" value="{{ old('url', optional($banners)->url) }}" minlength="1" maxlength="191"  placeholder="Enter title here...">
        {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
    </div>
</div>
