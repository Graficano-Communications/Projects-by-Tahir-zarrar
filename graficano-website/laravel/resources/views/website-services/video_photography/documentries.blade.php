...
@section('meta_title', 'Documentaries')
    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-6 position-relative ">
                <img class="border-radius-5px" src="{{asset('assets/images/sub-services/video-photography/Documentaries.webp')}}"
                    alt="" />
            </div>
            <div class="col-lg-6 col-md-6  sm-margin-30px-bottom offset-lg-1">
                <h1 class="alt-font font-weight-600 text-extra-dark-gray w-90" style="font-size:26px;">Documentaries 
                </h1>
                <p style="text-align: justify;">
                Documentaries are what we do best. Whether it’s a corporate project or a personal one, we bring your story to life through creativity and storytelling. We use modern equipment for filming and editing techniques to transform your experiences into engaging documentaries with impact. We can turn your experiences into stories that are visually engaging and inspiring.    
                </p>
                <p style="text-align: justify;">
                We have successfully satisfied clients from various fields e.g. surgical instruments manufacturers, sportswear, cricket gears manufacturers, leather products manufacturers, meat processing factories and many more.  
                </p>
                            ...
                            <div class="col-6">
                                ...
                                <li
                                    ...
                                    <li
                                        class=" border-radius-6px margin-20px-bottom last-paragraph-no-margin wow animate__fadeIn">
                                       <i class="fa fa-solid fa-check text-green margin-10px-right"></i>
                                       Arts and Culture Documentaries
                                    </li>
                                    <li
                                        class=" border-radius-6px margin-20px-bottom last-paragraph-no-margin wow animate__fadeIn">
                                        <i class="fa fa-solid fa-check text-green margin-10px-right"></i>
                                        Manufacturing Processes Documentaries 
                                    </li>
