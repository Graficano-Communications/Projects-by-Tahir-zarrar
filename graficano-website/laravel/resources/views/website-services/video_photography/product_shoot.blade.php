...
@section('meta_title', 'Photography ')
    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-6 position-relative ">
                <img class="border-radius-5px" src="{{asset('assets/images/sub-services/video-photography/product-shoot.webp')}}"
                    alt="" />
            </div>
            <div class="col-lg-6 col-md-6  sm-margin-30px-bottom offset-lg-1">
                <h1 class="alt-font font-weight-600 text-extra-dark-gray w-90" style="font-size:26px;">Photography    
                </h1>
                <p style="text-align: justify;">
                Our unique services help with telling amazing stories through photographs. Skilled artists use each image to tell engaging stories about special moments. From documenting memorable events to showcasing products and advertising graphics, we bring creativity and accuracy to every shot, making sure each image tells an amazing story.  </p> 
                 <p style="text-align: justify;">
                 Our pictures have a unique viewpoint that separates them from other images. Watch as we transform your idea into a series of beautiful shots that leave an impression. We invite you to experience the magic of imagery, where every shot tells a story and leaves an impression.  </p>
