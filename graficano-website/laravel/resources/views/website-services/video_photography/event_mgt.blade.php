...
@section('meta_title', 'Event Coverage')
    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-6 position-relative ">
                <img class="border-radius-5px" src="{{asset('assets/images/sub-services/video-photography/event-coverage.webp')}}"
                    alt="" />
            </div>
            <div class="col-lg-6 col-md-6  sm-margin-30px-bottom offset-lg-1">
                <h1 class="alt-font font-weight-600 text-extra-dark-gray w-90" style="font-size:26px;">Event Coverage  
                </h1>
                <p style="text-align: justify;">We bring the fun and excitement of your events to life with unparalleled creativity and dependability. Our experienced team members use modern equipment to record every moment, whether it's a public relations event or an influential meeting. We are committed to capturing your special occasion, whether it is a game show, a company meeting, or an opening ceremony.  </p>
           
                <p style="text-align: justify;">
                We handle all the logistics, filming, and post-production work. Trust us to provide you with an exceptional event experience from start to finish. We have a team of professionals who capture events with style and professionalism to ensure that your guests will make memorable memories. 
                </p>
                            ...
                            <div class="col-6">
                                <ul class="list-style-02 ">
                                    ...
                                    <li
                                        class=" border-radius-6px margin-20px-bottom last-paragraph-no-margin wow animate__fadeIn">
                                       <i class="fa fa-solid fa-check text-green margin-10px-right"></i>
                                       Conference or Seminar Coverage 
                                    </li>
                                    <li
                                        class=" border-radius-6px margin-20px-bottom last-paragraph-no-margin wow animate__fadeIn">
                                         <i class="fa fa-solid fa-check text-green margin-10px-right"></i>
