...
@section('meta_title', 'Wordpress Web Desing')
@section('meta_description',
    'Wordpress Web Desing')
@section('meta_tags', '')
<meta name="robots" content="noindex, nofollow" />
@section('content')

@include('website-services.banner', 
['name' => "Wordpress Web Desing", 
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-6 position-relative ">
                <img class="border-radius-5px" src="{{asset('assets/images/sub-services/web/word-press.webp')}}"
                    alt="" />
            </div>
            <div class="col-lg-6 col-md-6  sm-margin-30px-bottom offset-lg-1">
                <h1 class="alt-font font-weight-600 text-extra-dark-gray w-90" style="font-size:26px;">Wordpress Web Desing
                </h1>
