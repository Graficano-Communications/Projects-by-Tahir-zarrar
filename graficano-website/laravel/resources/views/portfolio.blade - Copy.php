...
@section('meta_title', $seo_data['title'])
@section('meta_description', $seo_data['description'])
@section('meta_tags', $seo_data['tags']) 
...
@section('content')
    ...
    <section class="departments-section">
        <div class="container">
            <h1 class="text-center service-heading"> {{ $service }}</h1>
                ...
                @else
                    <div class="grid">
                        @foreach ($portfolios as $portfolio)
                            ...
                            <div class="{{ $services }} portfolio-box" data-id="{{ $services }}"
                                        ...
                                        @if ($image)
                                            @if ($image->type == 'vimeo')
                                                <div style="height: 440px;"
                                                    class="embed-responsive embed-responsive-16by9 sd-gallery-video-player-div">
