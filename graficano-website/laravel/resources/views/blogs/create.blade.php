...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('blogs.blog.store') }}" enctype="multipart/form-data" accept-charset="UTF-8" id="create_blog_form" name="create_blog_form" class="form-horizontal">
            {{ csrf_field() }}
            @include ('blogs.form', [
                                        'blog' => null,
                                      ])
