...
(function ($) {
	...
	pr.add("(min-width: 1199px)", () => {
		// Select all wrapper sections
		document.querySelectorAll('.tp-panel-pin-area').forEach(area => {
			let panels = area.querySelectorAll('.tp-panel-pin');
			...
			panels.forEach((panel) => {
				gsap.to(panel, {
					scrollTrigger: {
						...
						endTrigger: area, // use the current area's endTrigger
						pinSpacing: false,
						markers: false,
					},
				});
