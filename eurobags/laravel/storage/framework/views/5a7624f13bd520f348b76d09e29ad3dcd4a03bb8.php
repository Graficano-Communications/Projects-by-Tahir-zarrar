...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - <?php echo e($product->meta_title); ?></title>
    <meta name="description" content="<?php echo e($product->meta_description); ?>">
    <meta name="keywords" content="<?php echo e($product->meta_description); ?>">
    <!--Google font-->
                ...
                <nav aria-label="breadcrumb" class="theme-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('products.catgeory', $category->slug)); ?>"><?php echo e($category->name); ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('product_by_category', [$category->slug, $subcategory->slug])); ?>">
                ...
                <div class="col-lg-5">
                    <div class="product-slick">
                        ...
                        <?php $__currentLoopData = $imags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <img src="<?php echo e(asset('images/products/' . $img)); ?>"
                                     alt=""
                                     class="img-fluid image_zoom_cls-<?php echo e($key); ?>">
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                        ...
                        <div class="row imgae-outside-thumbnail">
                            <div class="col-12 p-0">
                                <div class="slider-nav">
                                    ...
                                    <?php $__currentLoopData = $imags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div>
                                            <img src="<?php echo e(asset('images/products/' . $img)); ?>" alt=""
                                                 class="img-fluid">
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                ...
                <div class="col-lg-7 rtl-text">
                    <div class="product-right">
                            ...
                            <?php $__currentLoopData = $variations->unique('color_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $color_count = \App\product_variation::where('product_id', $var->product_id)
                                        ->where('color_id', $var->color_id)->count();
                                ...
                                <?php $__currentLoopData = $imags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($loop->first): ?>
                                        <li class="<?php if($var->color_id == $image->id): ?> active <?php endif; ?>">
                                            <a <?php if($status == 0): ?> style="pointer-events: none; text-align:center;" <?php endif; ?>
                                               href="<?php echo e(route('product', ['slug' => $product->slug, 'color' => $var->color->color])); ?>">
                                                <img src="<?php echo e(asset('images/products/' . $img)); ?>"
                                                     style="width:50px;height:auto; <?php if($status == 0): ?> opacity:0.2 <?php endif; ?>"
                        ...
                        <div class="product-description border-product">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel"><?php echo e($product->name); ?></h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="modal-body">
                                                <img src="<?php echo e(asset('images/products/size_charts/' . $product->size_chart)); ?>"
                                                     alt="" class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php if($check): ?>
                                <?php $__currentLoopData = $options->unique('option_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <h6 class="product-title size-text"><?php echo e($option->option->name); ?></h6>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="size-box">
                                    <ul>
                                        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li id="<?php echo e($opt->option_value->id); ?>"
                                                onclick="set_value('<?php echo e($opt->option_value->id); ?>', '<?php echo e($opt->option_value->name); ?>', '<?php echo e($opt->qty); ?>');"
                                                <?php if($opt->status == 0): ?> style="pointer-events: none; opacity:0.5;" title="Out of stock" <?php endif; ?>>
                                                <span><?php echo e($opt->option_value->name); ?></span>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                            ...
                            <form action="#" method="Post">
                                ...
                                <input type="hidden" name="price" id="price"
                                       value="<?php if($product->sale_price < $product->price): ?> <?php echo e($product->sale_price); ?> <?php else: ?> <?php echo e($product->price); ?> <?php endif; ?>">
                                <input type="hidden" value="<?php echo e($image->color); ?>" required name="color" id="clr">

                                <?php if($check): ?>
                                    <input type="hidden" value="<?php echo e($check->name); ?>" id="option_name">
                                ...
                                <?php $imgs = json_decode($image->images); ?>
                                <?php $__currentLoopData = $imgs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $immg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($loop->first): ?>
                                        <input type="hidden" value="<?php echo e(asset('images/products/' . $immg)); ?>"
                                               required name="image" id="image">
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <input type="hidden" name="_token" id="token" value="<?php echo e(Session::token()); ?>">

                                <?php if($status == 1): ?>
                                    <!-- In Stock Buttons -->
                                    <div class="product-buttons">
                                        <a href="mailto:info@euro-bags.com"
                                    ...
                                    <div class="product-buttons">
                                        <a href="https://api.whatsapp.com/send?phone=03461157705"
                                           style="margin-left: 0px"
                                           class="btn btn-solid">
                                        ...
                                        <div id="collapseTwo" class="collapse"
                                            ...
                                            <div class="card-body">
                                                <div class="mt-2 text-center">
                                                    <p><?php echo $product->terms_conditions; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseThree" class="collapse"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="comment-section">
                                                    ...
                                                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($review->status == 1): ?>
                                                            <li style="border-bottom:1px solid #d3d3d3;padding-bottom:10px">
                                                                <div class="media">
                                                                    <div class="media-body">
                                                                        ...
                                                                        <p style="padding:0px"><?php echo e($review->description); ?></p>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php endif; ?>
                                                ...
                                                <form class="theme-form" action="<?php echo e(route('add_review')); ?>" method="post">
                                                    <div class="form-row">
                                                        <div class="col-md-6">
                ...
                <div class="tab-content nav-material" id="top-tabContent">
                    ...
                    <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                        <div class="mt-4 text-center">
                            <iframe width="100%" height="650px" src="https://www.youtube.com/embed/<?php echo e(substr($product->video, strpos($product->video, "=") + 1)); ?>"
                        ...
                        <div class="col-12">
                            <div class="modal-bg addtocart">
                                ...
                                <div class="media">
                                    ...
                                    <?php  $imags = json_decode($image->images); ?>
                                    <?php $__currentLoopData = $imags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <img class="img-fluid pro-img"
                                            src="<?php echo e(asset('images/products/' . $img)); ?>" alt="">
                                        <?php endif; ?>    
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>        
                                    </a>
                                    <div class="media-body align-self-center text-center">
                                        ...
                                        <div class="buttons">
                                            <a href="<?php echo e(route('cart')); ?>" class="view-cart btn btn-solid">Your cart</a>
                                            <a href="<?php echo e(route('order')); ?>" class="checkout btn btn-solid">Check out</a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="p-6">
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="index.html"><img class="img-fluid" src="<?php echo e(asset('assets/images/Euro-Bags-logo.png')); ?>"
                                        alt="logo"></a>
                            ...
                            <div class="col-lg-6">
                                ...
                                <p class="text-dark"> <a class="font-weight-bold" href="https://wa.me/923461157705"><i class="fab fa-whatsapp mr-2 text-primary"></i> + (92) 3461157705</a>
                                </p>
                                <p class="text-dark"><i
                                        class="far fa-envelope mr-2 text-primary"></i>info@euro-bag.com</p>
                ...
                <div class="col-lg-6 bg-dark">
                    <div class="p-6">
                        ...
                        <p class="mb-0 text-white mt-5">©Copyright 2025 <a href="/"
                                class="text-primary">Euro Bags</a> All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
