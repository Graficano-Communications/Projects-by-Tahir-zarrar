...
header -->
                        ...
                        <div class="product-right">
                                            ...
                                            <li class="<?php if($var->color_id == $image->id): ?> active <?php endif; ?>">
                                                <a <?php if($status == 0): ?> style="pointer-events: none; text-align:center;" <?php endif; ?>
                                                    ...
                                                    <img src="<?php echo e(asset('images/products/' . $img)); ?>"
                                                        ...
                                                        alt="<?php echo e($var->color->color); ?>" class="img-fluid"
                            ...
                            <div class="product-description border-product">
                                ...
                                <form action="#" method="Post">
                                    ...
                                    <input type="hidden" value="<?php echo e($image->color); ?>" required name="color"
                                        id="clr">
                                    ...
                                    <input type="hidden" name="_token" id="token"
                                        value="<?php echo e(Session::token()); ?>">
    ...
    <a href="https://wa.me/923461157705?text=<?php echo e(rawurlencode('Hello, I am interested in ' . $product->name)); ?>" 
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                                ...
                                                <div class="card-body">
                                                                ...
                                                                <li
                                                                    ...
                                                                    <div class="media">
                                                                        <div class="media-body">
                                                                            ...
                                                                            <p style="padding:0px">
                                                                                <?php echo e($review->description); ?></p>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            <?php endif; ?>
                                                    ...
                                                    <form class="theme-form" action="<?php echo e(route('add_review')); ?>"
                                                        method="post">
                                                        <div class="form-row">
                            ...
                            <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                ...
                                <div class="mt-4 text-center">
                                    <iframe width="100%" height="650px"
                                        src="https://www.youtube.com/embed/<?php echo e(substr($product->video, strpos($product->video, '=') + 1)); ?>"
                                ...
                                <div class="modal-bg addtocart">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="buttons">
                                                <a href="<?php echo e(route('cart')); ?>" class="view-cart btn btn-solid">Your
                                                    cart</a>
                                                <a href="<?php echo e(route('order')); ?>" class="checkout btn btn-solid">Check
                                                    out</a>
                ...
                <div class="col-lg-6">
                    <div class="p-6">
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="/">
                                    <img class="img-fluid" src="<?php echo e(asset('assets/images/Euro-Bags-logo.png')); ?>"
                                        alt="logo">
                                </a>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(' <li><div class="total"><h5>subtotal : <span>RS. ' + total +
                            '</span></h5></div></li><li><div class="buttons"><a href="<?php echo e(route('cart')); ?>" class="view-cart">view cart</a><a href="<?php echo e(route('order')); ?>" class="checkout">checkout</a></div></li>'
                            ).appendTo('#showcart');
