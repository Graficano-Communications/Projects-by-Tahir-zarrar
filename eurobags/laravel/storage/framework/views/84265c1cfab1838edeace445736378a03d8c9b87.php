                    ...
                    <div class="col-12">
                        <div class="d-block d-md-flex align-items-center text-center">
                            <div class="mr-4 d-inline-block py-1">
                                <a href="#"><i
                                        class="far fa-envelope mr-2 fa-flip-horizontal text-primary"></i>info@euro-bag.com</a>
                            </div>
                            ...
                            <div class="d-inline-block py-1">
                                <ul class="list-unstyled">
                                    <li><a href=""><i class="fas fa-map-marker-alt text-primary mr-2"></i>NOUL MORE RORAS ROOADNEAR HARRAR SIALKOT</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
