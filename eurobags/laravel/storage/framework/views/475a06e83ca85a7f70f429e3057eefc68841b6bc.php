...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a href="<?php echo e(route('banners.index')); ?>">blogs
      - <small style="color: #eb252a;">count( <?php echo e($blogs->count()); ?> )</small></a></li>
  </ol>
</nav>
...
<?php endif; ?>
  ...
  <tbody id="blogSortable">
    ...
    <tr id="<?php echo e($blog->id); ?>">
      <td class="handle"><a class="btn" style="cursor:move"><i class="fa fa-align-justify"></i></a></td>
      <td><?php echo e($blog->title); ?> </td>
      <td><img src="<?php echo e(asset('images/blogs/' . $blog->images)); ?>"  class="img-resposive"  width="100px" height="50px" ></td>    
       <td style="display: flex;">
              <a href="<?php echo e(route('blogs.edit',$blog->id)); ?>"><button class="btn btn-success" type="button"><i class="fa fa-pencil" ></i></button></a>
...
function updateOrder(data) {
      ...
      var ajaxurl = '<?php echo e(route('sort_blog')); ?>';
