            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo e(route('our-team.index')); ?>">Our Team 
                            - <small style="color: #eb252a;">count( <?php echo e($teams->count()); ?> )</small>
                        </a>
                    </li>
                </ol>
            </nav>
                ...
                <table class="table table-striped bg-white">
                    ...
                    <tbody id="TeamSortable">
                        ...
                        <tr id="<?php echo e($team->id); ?>">
                            ...
                            <td>
                                <img src="<?php echo e(asset('images/' . $team->image)); ?>" class="img-resposive" width="100px" height="50px"><br>
                                <?php echo e($team->image); ?>

                            </td>
                            <td style="display: flex;">
                                <a href="<?php echo e(route('our-team.edit',$team->id)); ?>">
                                    <button class="btn btn-success" type="button"><i class="fa fa-pencil"></i></button>
                                </a>
                                <form action="<?php echo e(route('our-team.destroy',$team->id)); ?>" method="post">
...
function updateOrder(data) {
    ...
    var ajaxurl = '<?php echo e(route("sort_team")); ?>'; // <-- create this route in web.php
