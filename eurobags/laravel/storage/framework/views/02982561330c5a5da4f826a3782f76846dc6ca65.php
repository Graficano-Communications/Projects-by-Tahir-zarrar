...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        .bg-image-card {
            background: url('<?php echo e(asset('images/about-us-2.jpg')); ?>') no-repeat center center;
                            ...
                            <div class="portfolio-overlay">
                                <div class="portfolio-description">
                                    <div class="portfolio-info">
                                        <h5><a href="<?php echo e(route('products.catgeory', $cat->slug)); ?>"
                                                class="portfolio-title text-primary"><?php echo e($cat->name); ?></a></h5>
                                        <span class="text-dark">Category</span>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a class="portfolio-img" href="<?php echo e(asset('images/category/' . $cat->image)); ?>"><i
        ...
        <div class="container">
                ...
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-4">
                        <div class="case-study">
                            <div class="case-study-img" style="background-image: url('<?php echo e($firstImage); ?>');">
                            </div>
                            <div class="case-study-info">
                                <a class="case-study-title font-weight-bold" href="#">
                                    <?php echo e($department->name); ?> (Department #<?php echo e($loop->iteration); ?>)
                                </a>
                                <a href="<?php echo e(route('departments')); ?>" class="icon-btn"><i
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center mt-0 mt-md-4">
                    <a href="<?php echo e(route('departments')); ?>" class="btn btn-primary-round btn-round mx-3">View all
                        ...
                        <div class="item">
                            <div class="testimonial-item">
                                <div class="testimonial-avatar shadow">
                                    <img class="img-fluid rounded-circle" src="<?php echo e(asset('images/avatar-1.jpg')); ?>"
                                        alt="">
                                </div>
                ...
                <div class="col-xl-9 col-md-8">
                    <div class="owl-carousel" data-nav-arrow="false" data-items="4" data-md-items="4" data-sm-items="4"
                        ...
                        <div class="item">
                         ...
                         <div class="item">
                            <img class="img-fluid w-75 " src="<?php echo e(asset('/images/logistic/5.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="blog-post">
                            <div class="blog-post-image">
                                <img class="img-fluid" src="<?php echo e(asset('images/blogs/' . $blog->images)); ?>"
                                    alt="">
                            </div>
                            <div class="blog-post-content">
                                <div class="blog-post-info">
                                    <div class="blog-post-author">
                                        <a href="<?php echo e(route('blog_post', $blog->slug)); ?>"
                                            class="btn btn-light-round btn-round text-primary">Blog</a>
                                    </div>
                                    <div class="blog-post-date">
                                        <a
                                            href="<?php echo e(route('blog_post', $blog->slug)); ?>"><?php echo e(\Carbon\Carbon::parse($blog->created_at)->format('d M Y ')); ?></a>
                                    </div>
                                </div>
