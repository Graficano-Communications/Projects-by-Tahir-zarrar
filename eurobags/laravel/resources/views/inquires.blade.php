...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a href="{{route('events.index')}}">Inquiries -  <small style="color: #eb252a;">count( {{$inquires->count()}} )</small></a></li>
  </ol> 
</nav>
  ...
  <tbody id="EventSortable">
    ...
    <tr> 
      ...
      <td style="display: flex;">
        ...
        <a class="btn btn-success"  target="_blank" href="{{asset('/inquiry/'.$order->order_pdf)}}"><i class="fa fa-file-pdf-o"></i></a>
