            ...
            <div class="container-fluid">
                ...
                <div class="navbar-collapse collapse justify-content-lg-center">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown nav-item mega-menu {{ request()->is('products*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ request()->routeIs('media') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('media') }}">Inovation & Industry Insights</a>
                        </li>

                        {{-- <li class="nav-item {{ request()->routeIs('blog_posts') ? 'active' : '' }}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <a href="{{ route('home') }}"><img class="img-fluid"
                                        src="{{ asset('assets/images/Euro-Bags-logo.png') }}" alt="logo"></a>
                            ...
                            <div class="col-sm-6 col-lg-5 mb-4 mb-lg-0">
                                ...
                                <div class="footer-link">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li><a class="text-white" href="{{ route('departments') }}">Departments</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-5">
                                <h5 class="text-primary mb-2 mb-sm-4">Registration Number</h5>
                                <div class="footer-link">
                                    <ul class="list-unstyled mb-0">
                                        <li>
