...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active"><a href="{{route('banners.index')}}">blogs
...
@endif
  ...
  <tbody id="blogSortable">
    ...
    <tr id="{{$blog->id}}">
      ...
      <td>{{$blog->title}} </td>
      <td><img src="{{ asset('images/blogs/' . $blog->images)}}"  class="img-resposive"  width="100px" height="50px" ></td>    
