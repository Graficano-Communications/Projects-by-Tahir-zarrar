...
<div class="panel panel-default">
  <div class="panel-body">
  	  <form action="{{route('subcategories.update',$category->id)}}" method="post"  enctype="multipart/form-data"> 
  	  	@method('PUT')
             ...
             <div class="form-group">
                <label for="category_id">Select Category</label>
                 ...
                 <select id="category_id" class="form-control"  required="" name="category_id">
                  ...
                  @foreach($cats as $cat)
                  <option value="{{$cat->id}}" @if($cat->id === $category->category_id) selected='selected' @endif>{{$cat->name}}</option>
                  @endforeach 
                 </select>
             </div>
            ...
            <hr>
             ...
             <div class="form-group">
              ...
              <input type="text" class="form-control" id="meta_title" name="meta_title" required="" value="{{$category->meta_title}}" placeholder="Enter Meta Title">
             </div>
             <div class="form-group">
              <label for="meta_description">Meta Description</label>
              <textarea type="text" class="form-control" id="meta_description" name="meta_description" required="" placeholder="Meta Description..">{{$category->meta_description}}</textarea>
             </div>
