    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded" src="{{asset('assets/images/logo.png')}}" alt=""></a></div>
            </div>
            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center">{{ Auth::user()->name }}
        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                ...
                <ul class="sidebar-menu">
                    <li><a class="sidebar-header" href="{{route('inquires')}}"><i data-feather="home"></i><span>Orders</span></a></li>
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li>
                                ...
                                <ul class="sidebar-submenu">
                                    ...
                                    <li><a href="{{route('categories.index')}}"><i class="fa fa-circle"></i>List Category</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-circle"></i>
                                ...
                                <ul class="sidebar-submenu"> 
                                    <li><a href="{{route('subcategories.create')}}"><i class="fa fa-circle"></i>Add SubCategory</a></li>
                                    <li><a href="{{route('subcategories.index')}}"><i class="fa fa-circle"></i>List SubCategory</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="#"><i data-feather="clipboard"></i><span>Banners</span><i class="fa fa-angle-right pull-right"></i></a>
                               <ul class="sidebar-submenu">
                                  <li><a href="{{route('banners.index')}}"><i class="fa fa-circle"></i>List Banner</a></li>
                                  <li><a href="{{route('banners.create')}}"><i class="fa fa-circle"></i>Create Banner</a></li>
                              </ul>
                    </li>
                    <li>
                        <a class="sidebar-header" href="#"><i data-feather="users"></i><span>Teams</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('our-team.index') }}"><i class="fa fa-circle"></i>List Teams</a></li>
                            <li><a href="{{ route('our-team.create') }}"><i class="fa fa-circle"></i>Create Team</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('our-departments.index') }}"><i class="fa fa-circle"></i>List Departments</a></li>
                            <li><a href="{{ route('our-departments.create') }}"><i class="fa fa-circle"></i>Create Department</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="sidebar-header" href=""><i data-feather="tag"></i><span>Coupons</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('coupons.index')}}"><i class="fa fa-circle"></i>List Coupons</a></li>
                            <li><a href="{{route('coupons.create')}}"><i class="fa fa-circle"></i>Create Coupons </a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="#"><i data-feather="clipboard"></i><span>Pages</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('pages.index')}}"><i class="fa fa-circle"></i>List Page</a></li>
                            <li><a href="{{route('pages.create')}}"><i class="fa fa-circle"></i>Create Page</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="#"><i data-feather="clipboard"></i><span>Blogs</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('blogs.index')}}"><i class="fa fa-circle"></i>List Blogs</a></li>
                            <li><a href="{{route('blogs.create')}}"><i class="fa fa-circle"></i>Create Blog</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="#"><i data-feather="clipboard"></i><span>Events</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('events.index')}}"><i class="fa fa-circle"></i>List Events</a></li>
                            <li><a href="{{route('events.create')}}"><i class="fa fa-circle"></i>Create Event</a></li>
                        </ul>
                    </li>
                   
                    <li><a class="sidebar-header" href="#"><i data-feather="align-left"></i><span>Media</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('media.index')}}"><i class="fa fa-circle"></i>Media Lists</a></li>
                            <li><a href="{{route('media.create')}}"><i class="fa fa-circle"></i>Create Media</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="#"><i data-feather="align-left"></i><span>  Video</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{route('vimeos.index')}}"><i class="fa fa-circle"></i>Video Lists</a></li>
                            <li><a href="{{route('vimeos.create')}}"><i class="fa fa-circle"></i>Create Video</a></li>
                        </ul> 
                    </li>
                    
                    <li><a class="sidebar-header" href="reports.html"><i data-feather="bar-chart"></i><span>Reports</span></a></li>
                       
                    <li><a class="sidebar-header" href="{{ route('reviews') }}"><i data-feather="bar-chart"></i><span>Reviews</span></a></li>
...
<script defer type="text/javascript" src="{{ asset('assets/js/jquery-ui.min.js')}}"></script>
<!--Datepicker jquery-->
