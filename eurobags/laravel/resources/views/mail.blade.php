                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tr> 
                            ...
                            <td>
                                ...
                                <p>Hi , {{ $order->name }}</p>
                                @php $total = (float) str_replace(',', '',$order['total_amount']) @endphp
                                @if((double)$total > 40000.00)
                                <p>Your order has been placed yet in pending status. Since order amount has exceeded COD amount limit. Kindly make direct bank deposit in order to process your orders. Our bank details are as follows. You can forward your bank payment slip on this whatsapp no. 03454663399
                                    
                                </p>
                                <h4>bank</h4>
                                @else
                                <p>Your order has been successfully placed and being processed accordingly. We will provide you the tracking No and link soon. Remember it may take sometime to process the order depending on the product and inventory.</p>
                                    @endif
                                    <a href="https://www.tcsexpress.com/tracking" target="_blank">Track Order</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <img src="@php echo $item['image'] @endphp" alt="" width="70">
                            </td>
                           
                            <td valign="top" style="padding-left: 15px;">
                                
                                <h5 style="margin-top: 15px;">@php echo $item['name']; @endphp
                                   <br> color :  @php echo $item['color'] @endphp
                                   @if($item['options'] )
                                    @foreach(json_decode($item['options']) as $key => $node)
                                   <br> @php echo  $key; @endphp : @php echo $node @endphp
                                  @endforeach
                                  @endif
                                </h5>
                            </td>
                            ...
                            <td valign="top" style="padding-left: 15px;">
                                <h5 style="font-size: 14px; color:#444;margin-top:15px;    margin-bottom: 0px;">Color :
                                    <span> @php echo $item['color']; @endphp</span> </h5>
                                    
                                <h5 style="font-size: 14px; color:#444;margin-top: 10px;">QTY : <span>@php echo $item['qty'];  @endphp</span></h5>
                            </td>
                            <td valign="top" style="padding-left: 15px;">
                                @if($item['discount'])
                                <h5 style="font-size: 14px; color:#444;margin-top:15px"><b>Rs. @php  echo $item['discount_price']; @endphp</b> <del>Rs. @php  echo $item['price']; @endphp</del></h5>
                                @else
                                <h5 style="font-size: 14px; color:#444;margin-top:15px"><b>@php  echo $item['price']; @endphp</b></h5>
                                @endif
                            </td>
                        </tr>
                       @endforeach
                            ...
                            <tr>
                                <td
                                    ...
                                    <p
                                        ...
                                        {{$order['address']}},<br> {{$order['city']}} <br>{{$order['provice']}}, Pakistan</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                    <tr>
                        <td>
                            <a href="#" style="font-size:13px">Bags By Credo </a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size:13px; margin:0;">2021 Copy Right </p>
                        </td>
                    </tr>
                </table>
            </td>
