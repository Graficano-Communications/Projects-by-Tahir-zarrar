...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <meta name="keywords"
        content="Core Star Sports apparel, fitness wear, casual wear, performance clothing, athletic apparel, gym wear, activewear, stylish sportswear, premium fitness clothing, modern workout gear">
    <meta name="description"
        content="Core Star Sports is where strength meets style. Discover premium fitness and casual wear designed for those who push limits and live boldly — blending comfort, durability, and modern design. Trusted by athletes and everyday warriors.">
    <meta name="author" content="Core Star Sports">
    <meta name="csrf-token" content="{{ csrf_token() }}">


        <title>Core Star Sports</title>
