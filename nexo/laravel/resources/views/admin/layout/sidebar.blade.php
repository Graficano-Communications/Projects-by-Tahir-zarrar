     ...
     <div class="sidebar_blog_1">
         <div class="sidebar-header">
             <div class="logo_section">
                 <a href="{{ url('dashboard') }}"><img class="logo_icon img-responsive" src="{{ asset('assets/frontend/images/core-logo-2.png')}}" alt="#" /></a>
             </div>
         </div>
         <div class="sidebar_user_info text-center">
             <img class="img-responsive" src="{{ asset('assets/frontend/images/core-logo-2.png')}}" alt="#" width="150px" />
         </div>
     </div>
