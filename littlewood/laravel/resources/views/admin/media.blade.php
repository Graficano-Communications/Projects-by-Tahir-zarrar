...
<div class="container-fluid p-0">
    ...
    <div class="row text-end mb-3">
        <div>
            <a href="{{ url('add-media') }}" type="button" class="btn btn-info">
        ...
        <table class="table table-striped table-hover my-0">
            <thead>
                <tr class="py-3">
                    ...
                    <th class="d-none d-xl-table-cell text-uppercase py-3">Link</th>
            ...
            <tbody id="BrandSortable">
                ...
                <tr id="{{ $media->id }}">
                    ...
                    <td class="d-none d-xl-table-cell">{{ $media->link }}</td>
                    <td class="d-none d-md-table-cell text-end">
                        <a href="{{ route('edit-media', $media->id) }}" class="btn btn-success">
                            <i class="mb-1" data-feather="edit"></i> Edit
                        </a>
                    </td>
                    <td class="d-none d-md-table-cell text-start">
                        <form action="{{ route('delete-media', $media->id) }}" method="POST" onsubmit="return confirmDelete();">
                            @csrf
                            @method('DELETE')
