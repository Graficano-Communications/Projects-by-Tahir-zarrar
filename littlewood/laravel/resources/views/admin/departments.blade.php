...
<div class="container-fluid p-0">
    ...
    <div class="row text-end mb-3">
        <div>
            <a href="{{ route('add-department') }}" type="button" class="btn btn-info">
        ...
        <table class="table table-striped table-hover my-0">
            <thead>
                <tr class="py-3">
                    ...
                    <th class="d-none d-md-table-cell text-uppercase py-3">Department Image</th>
                    <th class="d-none d-md-table-cell text-uppercase text-center py-3" colspan="2">Action</th>
                    {{-- <th class="d-none d-md-table-cell text-uppercase py-3 text-center">Sub Departments</th> --}}
                </tr>
            </thead>
            <tbody id="DepartmentSortable">
                ...
                <tr id="{{ $department->id }}">
                    ...
                    <td class="d-none d-xl-table-cell">{{ $department->name }}</td>
                    <td class="d-none d-md-table-cell">
                        <img width="80px" height="40px" src="{{ asset('uploads/departments/' . $department->image) }}" alt="{{ $department->name }}" width="100">
                    </td>
                    <td class="d-none d-md-table-cell">
                        <img width="80px" height="40px" src="{{ asset('uploads/departments/' . $department->banner_image) }}" alt="{{ $department->name }}" width="100">
                    </td>
                    <td class="d-none d-md-table-cell text-end">
                        <a href="{{ route('edit-department', $department->id) }}" class="btn btn-success">
                            <i class="mb-1" data-feather="edit"></i> Edit
                        </a>
                    </td>
                    <td class="d-none d-md-table-cell text-start">
                        <form action="{{ route('delete-department', $department->id) }}" method="POST" onsubmit="return confirmDelete();">
                            @csrf
                            @method('DELETE')
                    ...
                    {{-- <td class="d-none d-md-table-cell text-center">
                        <a href="{{ route('admin-sub-departments', $department->id) }}" type="button" class="btn btn-info"> View</a>
                    </td> --}}
                </tr>
                @endforeach
            </tbody>
