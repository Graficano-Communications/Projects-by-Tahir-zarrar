...
@section('main-content')
    <div class="container-fluid p-0">
        ...
        <h1 class="h3 mb-3"><strong>Portfolios</h1>

        <div class="row">
            <form action="{{ url('add-portfolio-data') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Portfolio  Size Recomended (1920*1080)</h5>
                    </div>
                    <div class="card-body">
