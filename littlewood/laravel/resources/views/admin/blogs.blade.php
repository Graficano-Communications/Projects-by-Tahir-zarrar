...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3"><strong>Blogs</strong></h1>
        ...
        <table class="table table-striped table-hover my-0">
            <thead>
                <tr class="py-3">
                    ...
                    <th class="d-none d-xl-table-cell text-uppercase py-3">Image</th>
                    <th class="d-none d-xl-table-cell text-uppercase py-3">Blog Image</th>
                    <th class="d-none d-xl-table-cell text-uppercase text-center py-3" colspan="2">Action</th>
                </tr>
            </thead>
            <tbody id="BlogSortable">
                ...
                <tr id="{{ $blog->id }}">
                    ...
                    <td class="d-none d-xl-table-cell">{{ $blog->name }}</td>
                    <td class="d-none d-xl-table-cell">
                        <img width="80px" height="40px" src="{{ asset('uploads/blogs/' . $blog->image) }}" alt="{{ $blog->name }}" width="100">
                    </td>
                    <td class="d-none d-xl-table-cell">
                        <img width="80px" height="40px" src="{{ asset('uploads/blogs/' . $blog->banner_image) }}" alt="{{ $blog->name }}" width="100">
                    </td>
