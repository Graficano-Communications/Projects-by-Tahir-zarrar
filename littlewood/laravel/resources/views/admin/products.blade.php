            ...
            <table class="table table-striped table-hover my-0">
                <thead>
                    <tr class="py-3">
                        ...
                        <th class="d-none d-md-table-cell text-uppercase py-3">Url</th>
                        <th class="d-none d-md-table-cell text-uppercase py-3">Colors</th>
                        <th class="d-none d-md-table-cell text-uppercase py-3">Sizes</th>
                ...
                <tbody id="ProductSortable">
                    @foreach($products as $product)
                        <tr id="{{ $product->id }}">
                            ...
                            <td class="d-none d-md-table-cell">{{ $product->url }}</td>
                            <td class="d-none d-md-table-cell">{{ $product->colors }}</td>
                            <td class="d-none d-md-table-cell">{{ $product->sizes }}</td>
