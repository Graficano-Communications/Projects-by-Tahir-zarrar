 ...
 <nav id="sidebar">
    <div class="sidebar_blog_1">
       <div class="sidebar-header">
          <div class="logo_section">
             <a href="{{ url('dashboard') }}"><img class="logo_icon img-responsive" src="{{ asset('assets/admin/images/logo/ezsoft-org.png') }}"alt="#" /></a>
          </div>
       </div>
       <div class="sidebar_user_info text-center">
             <img class="img-responsive" src="{{ asset('assets/admin/images/logo/ezsoft-org.png') }}" alt="#" width="150px"/>
       </div>
    </div>
    <div class="sidebar_blog_2">
       ...
       <ul class="list-unstyled components">
         ...
         <li class="active">
            <a href="#additional_page3" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-user grey-theme-color"></i> <span>Our Team</span></a>
         ...
         <li class="active">
            <a href="#additional_page7" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-tasks grey-theme-color"></i> <span>Services</span></a>
