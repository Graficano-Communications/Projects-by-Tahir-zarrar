        ...
        <!-- table section -->
            <div class="white_shd full margin_bottom_30">
               <div class="full graph_head d-flex justify-content-between">
                  ...
                  <div>
                    <a href="{{ url('add-teams') }}" type="button" class="btn btn-info">
                     ...
                     <table class="table table-striped">
                        ...
                        <tbody>
                           ...
                           <tr id="{{ $team->id }}">
                              ...
                              <td>
                                <img width="80px" height="40px" src="{{ asset('uploads/teams/' . $team->image) }}" alt="{{ $team->name }}">
                              </td>
                              <td class="text-right">
                                <a href="{{ route('edit-team', $team->id) }}" class="btn btn-success">
                                <i class="fa fa-edit"></i> Edit
                                </a>
                            </td>
                            <td class="text-start">
                                <form action="{{ route('delete-team', $team->id) }}" method="POST" onsubmit="return confirmDelete();">
                                    @csrf
                                    @method('DELETE')
