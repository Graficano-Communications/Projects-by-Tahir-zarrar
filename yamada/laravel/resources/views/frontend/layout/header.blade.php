             ...
             <div class="row wrapper-header align-items-center">
                 ...
                 <div class="col-xl-2 col-md-4 col-6 text-center">
                     <a href="{{ route('home') }}" class="logo-header">
                         <img src="{{ asset('assets/frontend/images/front-images/yamada-logo.png') }}" alt="logo"
                             class="logo">
                     </a>
                 </div>
                 ...
                 <nav class="box-navigation text-center">
                     <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                             ...
                                             <div class="col-lg-2">
                                                 <div class="mega-menu-item">
                                                     <div  class="menu-heading">
                                                        <a href="{{ route('product.show', ['categorySlug' => $category->slug]) }}">{{ $category->name }}</a></div>
                                                     <ul class="menu-list">
                         ...
                         <li class="menu-item position-relative">
                             <a href="{{ route('news-event') }}" class="item-link">News & Events</a>
                             {{-- <div class="sub-menu submenu-default">
                                 <ul class="menu-list">
                                     <li>
                                         <a href="" class="menu-link-text link text_black-2">Upcooming</a>
                                     </li>
                                     <li>
                                         <a href="" class="menu-link-text link text_black-2">Recent</a>
                                     </li>
                                 </ul>
                             </div> --}}
                         </li>
                         <li class="menu-item">
                             <a href="{{ route('catalouges') }}" class="item-link">Catalouges</a>
                         </li>
                         <li class="menu-item">
