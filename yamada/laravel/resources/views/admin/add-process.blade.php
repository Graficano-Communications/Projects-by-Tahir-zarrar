            ...
            <div class="white_shd full margin_bottom_30">
                <div class="table_section padding_infor_info">
                    <div class="table-responsive-sm">
                        ...
                        <form class="w-100" action="{{ url('add-process-step-data') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <textarea class="form-control  shadow-none" rows="8" name="description" placeholder="Description"></textarea>
                                </div>
                            </div>
                            <div class="card mt-3">
                                <div class="card-header">
