                ...
                <div class="table_section padding_infor_info">
                    <div class="table-responsive-sm">
                        <div class="heading1 margin_0">
                            <h2>Add New News & Event</h2>
                         </div>
                        <form class="w-100" action="{{ url('add-amenity-data') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card">
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <input type="date" class="form-control shadow-none" name="date" placeholder="Enter Date" required>
                                </div>
                            </div>
                            <div class="card mt-3">
                                <div class="card-header">
