 ...
 <nav id="sidebar">
    <div class="sidebar_blog_1">
       <div class="sidebar-header">
          <div class="logo_section">
             <a href="{{ url('dashboard') }}"><img class="logo_icon img-responsive" src="{{ asset('assets/frontend/images/front-images/favicon.png') }}"alt="#" /></a>
          </div>
       </div>
       <div class="sidebar_user_info text-center">
             <img class="img-responsive" src="{{ asset('assets/admin/images/logo/yamada-logo.png') }}" alt="#" width="150px"/>
       </div>
    </div>
    <div class="sidebar_blog_2">
       ...
       <ul class="list-unstyled components">
          ...
          <li class="active">
             <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-image grey-theme-color"></i> <span>Banners</span></a>
         ...
         <li class="active">
          ...
          <li class="active">
            <a href="#element2" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-newspaper-o grey-theme-color"></i> <span>Blogs</span></a>
