                        ...
                        <form class="w-100" action="{{ route('add-blog-data') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="text" class="form-control shadow-none mt-2" name="qoute_writer"
                                        placeholder="Writer Name" required>
                                </div>
                            </div>
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Image (Size Recomended 1100 x 760)</h5>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Banner Image (Size Recomended 1900 x 600)</h5>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control" name="editor2" rows="8" required placeholder="Enter description"></textarea>
                                </div>
                            </div>
                            <div class="px-3 mt-3">
