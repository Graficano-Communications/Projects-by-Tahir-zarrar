...
Route::get('mdr', [FrontController::class, 'mdr'])->name('mdr');
Route::get('catalog', [FrontController::class, 'catalouge'])->name('catalouges');
Route::get('contact-us', [FrontController::class, 'contact']);
Route::get('blogs', [FrontController::class, 'blog'])->name('blog.show');
Route::get('products/{category_name}/{subcategory_name?}', [FrontController::class, 'products'])->name('product.show');
Route::get('blog-detail/{id}', [FrontController::class, 'blog_detail'])->name('blog.detail');
Route::get('/{category_name}/subcategories', [FrontController::class, 'Subcategories'])->name('category.subcategories');
