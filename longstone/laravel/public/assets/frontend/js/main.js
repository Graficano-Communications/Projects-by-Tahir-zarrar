!(function (t) {
  ...
  if (
    ...
    document.querySelectorAll(".instafeed-wrapper").forEach(function (e, a) {
      var o =
          "IGQVJWYmtnaTM5cnNtejVlcTBuODBUenotNl9raGNxNWZA4clFzR3F1T00zdnUxbmhXbUNBQXp5Q3N4dzduVm5vZAWtOc1kwZAmtZAUFF0OFN6UE50ZAkVGSmJvaVFTLWVCb3MxR2lTaXBQWGVSVW9QUHA1VwZDZD",
        i = t(e),
  ...
  var P = window.location.href.substr(
        ...
        if (null != i) {
          ...
          if ("" != i.thumbs && null != i.thumbs) {
            ...
            if ("" != l && null != l) {
              ...
              i.thumbs.swiper.on = {
                init: function () {
                  z() <= n ? this.changeDirection(l) : this.changeDirection(c),
                    this.update();
                },
                resize: function () {
                  z() <= n ? this.changeDirection(l) : this.changeDirection(c),
          ...
          "" != p &&
            ...
            (i.on.slideChange = function () {
              t(".swiper-pagination-current").length > 0 &&
                t(".swiper-pagination-current").html(D(this.realIndex + 1)),
                t(".swiper-pagination-total").length > 0 &&
                  t(".swiper-pagination-total").html(D(this.slides.length - 2));
            });
  ...
  function B() {
    for (var e = 0; e < d.length; e++) {
      ...
      "" != a &&
        null != a &&
        (z() <= a ? t.destroy(!1, !0) : t.destroyed && (d.splice(e, 1), N()));
    }
  }
  function W() {
    setTimeout(function () {
  ...
  function V() {
    ...
    (!t(".navbar").hasClass("top-space") &&
      ...
      t(".mobileoff-fullscreen-top-space").length >= 0 &&
        z() > 1023 &&
        t(".mobileoff-fullscreen-top-space").css("height", j() - e + "px"),
      t(".fullscreen-top-space").length >= 0 &&
        t(".fullscreen-top-space").css("height", j() - e + "px"),
      (t(".sidebar-nav-action").length > 0 ||
        t(".side-menu-header").length > 0) &&
        (z() <= i
          ? t("body").css("padding-top", e + "px")
