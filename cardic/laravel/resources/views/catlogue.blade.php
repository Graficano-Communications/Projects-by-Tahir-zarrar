...
@section('title', 'Catalogues | Cardic Instruments')
            ...
            <div class="row flex-column flex-lg-row justify-content-center align-items-lg-end extra-very-small-screen">
                <div class="col-xxl-8 col-md-7 position-relative page-title-large md-mb-30px sm-mb-20px">
                    <h1 class="text-white alt-font fw-500 ls-minus-1px mb-0 font-style-italic"
                        data-fancy-text='{ "opacity": [0, 1], "delay": 500, "speed": 50, "string": ["Catalogues"], "easing": "easeOutQuad" }'>
                    </h1>
                </div>
                <div class="col-xxl-4 col-lg-5 col-md-7 col-sm-9 last-paragraph-no-margin"
                    ...
                    <p class="text-white opacity-8">
                        All catalogs and introductory booklets can be loaded directly, but for security purposes, these
                        ...
                        @foreach ($catlogs as $catlog)
                            @if ($catlog->type == 'catalog')
                                <li class="grid-item">
                                    ...
                                    <span class="fs-20 text-black text-center mb-10px d-block">{{ $catlog->name }}</span>
                                </li>
                            @endif
                        @endforeach
                        <!-- end blog item -->
