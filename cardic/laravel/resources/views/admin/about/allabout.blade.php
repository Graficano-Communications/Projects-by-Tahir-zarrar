            ...
            <tbody id="CategorySortable">
                @foreach ($about as $key => $cat)
                    <tr id="{{ $cat->id }}">
                        ...
                        <td>{{ $cat->page_name }}</td>
                        <td> <img src="{{ asset('images/about/' . $cat->image) }}" class="img-resposive" 
                                height="100px"></td>
						<td> <img src="{{ asset('images/about/' . $cat->banner) }}" class="img-resposive"
							height="100px"></td>
                        <td>
                            <h4>
                                <a href="{{ route('about_edit', $cat->id) }}"><span class="label label-success"><i
                                            class="fa fa-pencil-square"></i></span></a>
                                <a href="{{ route('del_pag', $cat->id) }}"
