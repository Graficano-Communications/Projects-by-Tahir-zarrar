...
@section('title', 'Blog – News, Insights & Updates')
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="item mb-50">
                            <div class="img">
                                ...
                                <div class="date">
                                    <a href="{{ route('blog.detail', $blog->slug) }}">30 august 2021</a>
                                </div>
                            </div>
                            <div class="cont mt-30">
                                ...
                                <a href="{{ route('blog.detail', $blog->slug) }}" class="mt-20 ls1 sub-title">Read More <i
