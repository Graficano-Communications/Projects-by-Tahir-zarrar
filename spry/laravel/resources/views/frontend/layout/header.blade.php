...
<nav class="navbar nav-crev navbar-expand-lg">
    <div class="container-fluid">

        <!-- Logo -->
        <a class="logo icon-img-180 p-2" href="{{ route('home') }}">
            <img src="{{ asset('assets/frontend/imgs/logospry.png') }}" alt="logo">
        </a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('compliances') }}">Compliance</a>
                    </div>
                </li>
                @php
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('news.show') }}"><span class="rolling-text">News &
                            Events</span></a>
                </li>
                <li class="nav-item ">
                ...
                {{-- <li class="nav-item ">
                    <a class="nav-link" href="{{ route('blog.show') }}"><span class="rolling-text">Blog</span></a>
                </li> --}}
                <li class="nav-item">
