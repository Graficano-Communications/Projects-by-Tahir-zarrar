...
class AmenitiesController extends Controller
{
    ...
    public function add_amenity_data(Request $request)
    {
        ...
        return redirect()->route('all-amenities')->with('status', 'Amenity Added Successfully');
    }
    ...
    public function edit_amenity_data(Request $request, $id)
    {
        ...
        return redirect()->route('all-amenities')->with('status', 'Amenity Updated Successfully');
    }
    ...
    public function delete_amenity($id)
    {
        ...
        return redirect()->back()->with('status', 'Amenity Deleted Successfully');
    }
