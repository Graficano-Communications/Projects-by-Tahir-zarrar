...
@section('main-container')
    ...
    <section class="pb-0 pt-md-0 ps-13 pe-13 lg-ps-4 lg-pe-4 sm-p-0">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12"><img src="{{ asset('uploads/blogs/' . $blog->banner_image) }}" class="w-100" alt=""></div>
            </div>
        </div>
    </section>
    <!-- end section -->
    ...
    <section class="pb-0 pt-md-0 ps-13 pe-13 lg-ps-4 lg-pe-4 sm-p-0">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12"><img src="{{ asset('uploads/blogs/' . $blog->image) }}" class="w-100" alt=""></div>
            </div>
        </div>
    </section>
    <!-- end section -->
    ...
    <!-- end section -->
    <!-- start section -->
    <section id="comments" class="pb-30px sm-pb-50px overlap-height">
