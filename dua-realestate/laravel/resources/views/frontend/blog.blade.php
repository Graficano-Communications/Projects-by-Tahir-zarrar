        ...
        <div class="container">
            <div class="row align-items-center align-items-lg-end justify-content-center extra-very-small-screen g-0">
                <div class="col-xxl-5 col-xl-6 col-lg-7 position-relative page-title-extra-small md-mb-30px md-mt-auto" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                    <h1 class="text-base-color">Our latest property articles</h1>
                    <h2 class="alt-font text-dark-gray fw-500 mb-0 ls-minus-1px shadow-none" data-shadow-animation="true" data-animation-delay="700">Follow the latest <span class="fw-700 text-highlight d-inline-block">real estate<span class="bg-base-color h-10px bottom-10px opacity-3 separator-animation"></span></span> news.</h2>
                </div>
                <div class="col-lg-5 offset-xxl-2 offset-xl-1 border-start border-2 border-color-base-color ps-40px sm-ps-25px md-mb-auto">
                    <span class="d-block w-85 lg-w-100" data-anime='{ "el": "lines", "translateY": [15, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>Stay updated with the latest news in real estate. As a premier marketplace, we specialize in selling luxury homes, and helping clients find their perfect properties.</span>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row overlap-height">
                <div class="col-12 p-0 position-relative overlap-gap-section">
                    <img src="{{ asset('assets/frontend/images/blogs.jpg') }}" alt="" class="w-100">
                        ...
                        <li class="grid-item">
                            <div class="card bg-transparent border-0 h-100">
                                ...
                                <div class="card-body px-0 pb-30px pt-30px xs-pb-15px">
                                    <span class="fs-14 text-uppercase"><a href="#" class="text-dark-gray fw-500 categories-text">Blog</a><a href="#" class="blog-date">{{ $item->created_at->format('d F Y') }}</a></span>
