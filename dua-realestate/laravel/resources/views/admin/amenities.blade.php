        ...
        <!-- table section -->
            <div class="white_shd full margin_bottom_30">
               <div class="full graph_head d-flex justify-content-between">
                  ...
                  <div>
                    <a href="{{ url('add-amenities') }}" type="button" class="btn btn-info">
                     ...
                     <table class="table table-striped">
                        ...
                        <tbody>
                           ...
                           <tr id="{{ $amenities->id }}">
                              ...
                              <td>
                                <img width="80px" height="40px" src="{{ asset('uploads/amenities/' . $amenities->image) }}" alt="{{ $amenities->caption }}">
                              </td>
                              <td class="text-right">
                                <a href="{{ route('edit-amenity', $amenities->id) }}" class="btn btn-success">
                                <i class="fa fa-edit"></i> Edit
                                </a>
                            </td>
                            <td class="text-start">
                                <form action="{{ route('delete-amenity', $amenities->id) }}" method="POST" onsubmit="return confirmDelete();">
                                    @csrf
                                    @method('DELETE')
...
<script>
    function confirmDelete() {
        return confirm('Are you sure you want to delete this amenities?');
    }
