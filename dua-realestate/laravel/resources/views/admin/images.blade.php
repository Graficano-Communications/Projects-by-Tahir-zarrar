        ...
        <!-- table section -->
            <div class="white_shd full margin_bottom_30">
               <div class="full graph_head d-flex justify-content-between">
                  ...
                  <div>
                    <a href="{{ url('add-images') }}" type="button" class="btn btn-info">
                     ...
                     <table class="table table-striped">
                        ...
                        <tbody>
                           ...
                           <tr id="{{ $images->id }}">
                              ...
                              <td>
                                <img width="80px" height="40px" src="{{ asset('uploads/images/' . $images->image) }}" alt="{{ $images->caption }}">
                              </td>
                              <td class="text-right">
                                <a href="{{ route('edit-image', $images->id) }}" class="btn btn-success">
                                <i class="fa fa-edit"></i> Edit
                                </a>
                            </td>
                            <td class="text-start">
                                <form action="{{ route('delete-image', $images->id) }}" method="POST" onsubmit="return confirmDelete();">
                                    @csrf
                                    @method('DELETE')
