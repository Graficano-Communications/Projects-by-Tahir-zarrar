        ...
        <!-- table section -->
            <div class="white_shd full margin_bottom_30">
               <div class="full graph_head d-flex justify-content-between">
                  ...
                  <div>
                    <a href="{{ url('add-videos') }}" type="button" class="btn btn-info">
                     ...
                     <table class="table table-striped">
                        ...
                        <tbody>
                           ...
                           <tr id="{{ $videos->id }}">
                              ...
                              <td>{{ $videos->link }}</td>
                              <td class="text-right">
                                <a href="{{ route('edit-video', $videos->id) }}" class="btn btn-success">
                                <i class="fa fa-edit"></i> Edit
                                </a>
                            </td>
                            <td class="text-start">
                                <form action="{{ route('delete-video', $videos->id) }}" method="POST" onsubmit="return confirmDelete();">
                                    @csrf
                                    @method('DELETE')
