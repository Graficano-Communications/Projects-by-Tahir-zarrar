 ...
 <nav id="sidebar">
     <div class="sidebar_blog_1">
         <div class="sidebar-header">
             <div class="logo_section">
                 <a href="{{ url('dashboard') }}"><img class="logo_icon img-responsive"
                         src="{{ asset('assets/admin/images/logo/black-bear-logo.png') }}"alt="#" /></a>
             </div>
         </div>
         <div class="sidebar_user_info text-center">
             <img class="img-responsive" src="{{ asset('assets/admin/images/logo/black-bear-logo.png') }}" alt="#"
                 width="150px" />
         </div>
     </div>
     <div class="sidebar_blog_2">
         ...
         <ul class="list-unstyled components">
             <li class="active">
                 <a href="{{ url('dashboard') }}"><i class="fa fa-dashboard grey-theme-color"></i>
                     <span>Dashboard</span></a>
             </li>
             <li class="active">
                 <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-image grey-theme-color"></i> <span>Banners</span></a>
             ...
             <li class="active">
                 <a href="#additional_page3" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-user grey-theme-color"></i> <span>Our Team</span></a>
             ...
             <li class="active">
                 <a href="#additional_page4" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-tasks grey-theme-color"></i> <span>Departments</span></a>
             ...
             <li class="active">
                 <a href="#additional_page5" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-table grey-theme-color"></i> <span>Catalogues</span></a>
             ...
             <li class="active">
                 <a href="#additional_page7" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-tasks grey-theme-color"></i> <span>Products</span></a>
             ...
             <li class="active">
                 <a href="#additional_page8" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-table grey-theme-color"></i> <span>Category</span></a>
             ...
             <li class="active">
                 <a href="#additional_page9" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-table grey-theme-color"></i> <span>News Events</span></a>
             ...
             <li class="active">
                 <a href="#element2" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                         class="fa fa-newspaper-o grey-theme-color"></i> <span>Blogs</span></a>
