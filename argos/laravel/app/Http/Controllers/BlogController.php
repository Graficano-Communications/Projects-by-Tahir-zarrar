...
class BlogController extends Controller
{
    ...
    public function update_blog(Request $request, $id)
    {
        ...
        if ($request->hasFile('banner_image')) {
            ...
            if (!empty($blog->banner_image) && File::exists('uploads/blogs/' . $blog->banner_image)) {
                File::delete('uploads/blogs/' . $blog->banner_image);
            }
            ...
            $bannerFile->move('uploads/blogs/', $bannerFilename);
