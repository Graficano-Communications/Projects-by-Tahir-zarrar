                    ...
                    <div class="heading1 margin_0">
                     ...
                     <form action="{{ route('add-product-data') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <input type="text" class="form-control shadow-none" name="product_name" placeholder="Product Name" required>
                            </div>
                        </div>
                        <div class="card mt-3">
                            <div class="card-header">
                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <input type="text" class="form-control shadow-none" name="product_description" placeholder="Product Description" required>
                            </div>
                        </div>
                        <div class="card mt-3">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                                <input type="file" class="form-control shadow-none" name="product_images[]" multiple required>
                                <small class="text-muted">You can upload multiple images by selecting them all at once.</small>
                            </div>
                        </div>                        
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="variationTableBody">
                                        <tr>
                                            <td><input type="text" name="variation_name[]" class="form-control shadow-none" placeholder="Name/Code" required></td>
                                            <td><input type="text" name="variation_size[]" class="form-control shadow-none" placeholder="Size" required></td>
                                            <td><input type="text" name="variation_finish[]" class="form-control shadow-none" placeholder="Detail" required></td>
                                            <td><input type="text" name="variation_code[]" class="form-control shadow-none" placeholder="Price" required></td>
