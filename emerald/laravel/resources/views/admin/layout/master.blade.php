...
<html lang="en">
    <head>
        ...
        <!-- site metas -->
        <meta name="keywords"
        content="EMERALD INSTRUMENTS apparel, fitness wear, casual wear, performance clothing, athletic apparel, gym wear, activewear, stylish sportswear, premium fitness clothing, modern workout gear">
    <meta name="description"
        content="EMERALD INSTRUMENTS is where strength meets style. Discover premium fitness and casual wear designed for those who push limits and live boldly — blending comfort, durability, and modern design. Trusted by athletes and everyday warriors.">
    <meta name="author" content="EMERALD INSTRUMENTS">


        <title>EMERALD INSTRUMENTS</title>

        <!-- site icon -->
           <link rel="shortcut icon" href="{{ asset('assets/frontend/images/emd-favicon.png') }}">
        <!-- bootstrap css -->
