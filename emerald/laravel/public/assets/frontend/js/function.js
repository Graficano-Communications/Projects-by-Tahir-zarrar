(function ($) {
	...
	if ($('.testimonial-slider2').length) {
		const testimonial_slider2 = new Swiper('.testimonial-slider2 .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
	...
	if ($('.testimonial-company-slider2').length) {
    const testimonial_company_slider2 = new Swiper('.testimonial-company-slider2 .swiper', {
        slidesPerView : 1,
        speed: 900,
        spaceBetween: 30,
        loop: true,
